 ...
 */
// The geometry lives in lib/brand.ts, which the server-rendered icon routes
// also read. Re-exported here so existing imports keep working.
import { SPARK_PATH } from "@/lib/brand";
