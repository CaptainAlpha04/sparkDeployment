    ...
    <>    
      ...
      <div className='w-screen absolute bottom-10 md:bottom-32'>
        ...
        <img src="/designs/layer-1.png" alt="" className='absolute animation-fade-in'
          ...
          <section className="relative w-screen h-fit py-20 px-10 mb-20  flex flex-col bg-gradient-to-b from-slate-950 to-base-300">
            <h2 className="text-6xl font-bold text-center text-base-content">Global Impact</h2>
            <p className='text-md mt-16 font-light drop-shadow-lg md:px-32 text-justify'>We aim to create a <strong className='text-xl'>global impact</strong> by fostering a community of innovators, entrepreneurs, and leaders who are equipped to <strong className='text-xl'>solve</strong> challenges that transcend borders. Through collaboration across industries and cultures, SPARK <strong className='text-xl'>connects</strong> individuals worldwide, enabling the exchange of ideas, skills, and resources. By focusing on <strong className='text-xl'>universal</strong> pillars like creativity, research, and technology, Our initiatives are designed to address global issues such as education reform, <strong className='text-xl'>sustainable</strong> innovation, and social entrepreneurship, ensuring that its solutions benefit not only local communities but also the global <strong className='text-xl'>society</strong> at large.</p>
